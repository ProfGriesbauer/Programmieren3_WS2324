...
namespace OOPGames
{
    public abstract class A_BaseTicTacToePaint : IX_PaintTicTacToe
    {
    ...
    public abstract class A_BaseTicTacToeField : IX_TicTacToeField
    {
    ...
    public abstract class A_BaseHumanTicTacToePlayer : IX_HumanTicTacToePlayer
    {
        public abstract string Name { get; }
    ...
    public abstract class A_BaseComputerTicTacToePlayer : IX_ComputerTicTacToePlayer
    {
        public abstract string Name { get; }
