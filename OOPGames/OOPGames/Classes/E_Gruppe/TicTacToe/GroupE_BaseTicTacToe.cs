...
namespace OOPGames
{
    public abstract class E_BaseTicTacToePaint : IX_PaintTicTacToe
    {
    ...
    public abstract class E_BaseTicTacToeField : IX_TicTacToeField
    {
    ...
    public abstract class E_BaseTicTacToeRules : IX_TicTacToeRules
    {
    ...
    public abstract class E_BaseHumanTicTacToePlayer : IX_HumanTicTacToePlayer
    {
        public abstract string Name { get; }
    ...
    public abstract class E_BaseComputerTicTacToePlayer : IX_ComputerTicTacToePlayer
    {
        public abstract string Name { get; }
