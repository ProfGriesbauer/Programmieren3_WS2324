...
namespace OOPGames
{
    public abstract class X_BaseTicTacToePaintSH : IX_PaintTicTacToe
    {
    ...
    public abstract class X_BaseTicTacToeFieldSH : IX_TicTacToeField
    {
    ...
    public abstract class X_BaseTicTacToeRulesSH : IX_TicTacToeRules
    {
    ...
    public abstract class X_BaseHumanTicTacToePlayerSH : IX_HumanTicTacToePlayer
    {
        public abstract string Name { get; }
    ...
    public abstract class X_BaseComputerTicTacToePlayerSH : IX_ComputerTicTacToePlayer
    {
        public abstract string Name { get; }
